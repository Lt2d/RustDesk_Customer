...
impl LocalConfig {
    fn load() -> LocalConfig {
        ...
        if !config.options.contains_key("enable-confirm-closing-tabs") {
            config.options.insert("enable-confirm-closing-tabs".to_string(), "N".to_string());
            store = true;
        }
        if !config.options.contains_key("enable-open-new-connections-in-tabs") {
            config.options.insert("enable-open-new-connections-in-tabs".to_string(), "N".to_string());
            store = true;
        }
